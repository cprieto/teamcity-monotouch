...
<l:settingsGroup title="Executable Paths">
    <tr>
        <th>
            <label for="tsqlt.user_domain">Monodevelop Tool Path: </label>
            <span class="smallNote">Let empty to use default</span>
        </th>
        <td>
